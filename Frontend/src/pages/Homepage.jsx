    ...
    return <>
        ...
        <div className="w-full">
            ...
            <div >
                ...
                <PageText text={"We understand that fitness goals very, and so do individual perferences. \n That's why we off a range of membership plans to cater to diverse \n needs. Choose the one that aligns perfectly with your lifestyle and fitness aspirations."} />
                <div className={`flex flex-col md:flex-row justify-evenly items-center m-[30px] `}>

                    <Plans heading={"silver"} list={["Full Access", "Participation in group", "Assessment and orientation", "Rooms and Shower facilities"]} />

                    <Plans heading={"Gold"} list={["All Features of Basic plan", "Discounts on personal training sessions", "Premium locker room and amenities.", "Rooms and Shower facilities"]} />

                    <Plans heading={"Platinum"} list={["All Features of Basic and Premium plan", "Personal Coach", "Personal diet plan and assessment", "Unlimited access to all classes"]} />
                </div>
