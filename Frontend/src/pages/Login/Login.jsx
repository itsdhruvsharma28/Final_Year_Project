...
<div style={{display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", paddingTop:"10%"}}>
        ...
        <div style={{ textAlign: "center" , color:"black" }} className="">Test username:dhruv, Password: mainhoon</div>
        <div className=" w-full flex items-center justify-center pt-0 mt-0">
