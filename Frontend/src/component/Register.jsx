...
const Register = () => {
    ...
    return <>
        ...
        <div style={{ textAlign: "center" }} className="">{msg === "OK" ? <p>Current Status: Server is Running <br /> Test email: joy_mathur@gmail.com , username: joyy_m , password: 11223344</p> :<p>Server is Down try going to link <a target="_blank" style={{ textDecoration: "underline" }} href="https://gymer-backend.onrender.com/">Server link </a> to start server (takes 1min)</p>}</div>
