        ...
        <>
            <div className="bg-black p-6 fixed text-white w-screen">
                <div className="flex justify-between items-center">
                    <div className=" duration-300 font-bold hover:text-orange-700">FIT-BIT</div>
                    ...
                    <div className="hidden md:flex md:justify-center md:items-center">
                        ...
                        <div>
                            <a href={"https://www.linkedin.com/in/dhruv28/"} target="__blank__" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-md font-medium ">About</a>
                        </div>
                        <div>
                            <Link to={"/rates"} className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-md font-medium">Plans</Link>
                        </div>
                        <div>
